...
const NotFound = () => {
    return (
        <section class="flex items-center h-full p-16 bg-gray-50">
            <div class="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                <div class="max-w-md text-center">
                    ...
                    <a rel="noopener noreferrer" href="/home" class="px-8 py-3 font-semibold rounded bg-lime-600 text-gray-50">Back to homepage</a>
                </div>
            </div>
        </section>
    )
